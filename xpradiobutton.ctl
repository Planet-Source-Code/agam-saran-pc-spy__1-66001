...
Begin VB.UserControl xpradiobutton 
   ...
   Begin VB.Image img 
      ...
      Index           =   5
      Left            =   360
      Picture         =   "xpradiobutton.ctx":05CC
      Top             =   1080
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   4
      Left            =   120
      Picture         =   "xpradiobutton.ctx":0816
      Top             =   1080
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   3
      Left            =   840
      Picture         =   "xpradiobutton.ctx":0A60
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   2
      Left            =   600
      Picture         =   "xpradiobutton.ctx":0ABB
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   1
      Left            =   360
      Picture         =   "xpradiobutton.ctx":0D05
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
   Begin VB.Image img 
      ...
      Index           =   0
      Left            =   120
      Picture         =   "xpradiobutton.ctx":0F4F
      Top             =   840
      Visible         =   0   'False
      Width           =   195
   End
...
Private Sub UserControl_Resize()
    ...
    lbl.Top = (UserControl.Height - lbl.Height) \ 2 - 25
    lbl.Left = 300
End Sub
